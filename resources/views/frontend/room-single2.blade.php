          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos31.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos32.jpg);"></div>
          				</div>
                        <div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos33.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos34.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Kost Khusus Putri <span>- (Dekat paskal 23,BINUS)</span></h2>
    						<p>Fasilitas: <br> 1. Kamar mandi dalam <br> 2. Bed(kasur) <br> 3. Lemari kamar <br> 4. Meja belajar<br>
                            5. Ac/ kipas angin <br> 6.Water Heater <br> 7. Dapur Bersama <br> 8. Akses masuk Finger print <br> 9. CCTV 24 Jam <br>
                            Lokasi: <br>
                            - Jl. Sukamanah No.25 Bandung <br>
                             Harga: Rp. 1.500.000/perbulan <br></p>
          		</div>
