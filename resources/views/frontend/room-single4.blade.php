          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos51.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos52.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Kontrakan Rumah <span>- (BUMI SILIWANGI)</span></h2>
    						<p>Fasilitas: <br> 1. Kamar mandi 1 <br> 2. Kamar tidur 3 <br> 3. Carport <br> 4.Halaman Belakang <br> - Type 65 <br> <br>
                            Lokasi: <br>
                            - Baleendah Kab.Bandung <br>
                            - Harga: Rp. 27.000.000/pertahun <br>
                            -  Hubungi Lebih Lanjut: 08281384626428</p>
          		</div>
