          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos41.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos42.jpg);"></div>
          				</div>
                        <div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos43.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos44.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Kost <span>- (Dekat kampus Uninus)</span></h2>
    						<p>Fasilitas: <br> 1. Kamar mandi dalam <br> 2. Bed(kasur) <br> 3. Lemari <br> 4. Meja belajar<br>
                            5. Kloset duduk <br> 6.Parkir motor <br> 7. Dapur Bersama <br> <br>
                            Lokasi: <br>
                            - Jl. Cijawura Girang VI no 08 Bypass Soekarno Hatta. Dekat kampus Uninus,Unibi,Carefour Kiaracondong <br>
                            - Harga: Rp. 700.000/perbulan <br>
                            -  Hubungi Lebih Lanjut: 0856871664097</p>
          		</div>
