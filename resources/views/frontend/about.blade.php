        ...
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            ...
	            <h1 class="mb-4 bread">Tentang Ada kost</h1>
            </div>
          </div>
        </div>
      </div>
			...
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-7 order-md-last d-flex">
						<div class="img img-1 mr-md-7 ftco-animate" style="background-image: url(assets/frontend/images/bdg.jpg);"></div>
					</div>
					<div class="col-md-5 wrap-about pb-md-3 ftco-animate pr-md-5 pb-md-5 pt-md-4">
	          <div class="heading-section mb-4 my-5 my-md-0">
	          	<span class="subheading">Apa itu ada-kost?</span>
	          </div>
	          <p>Ada-kost menyajikan Sistem informasi kosan atau kontrakan,lengkap dengan fasilitas kost, harga kost,
            beserta foto desain kamar yang sebisa mungkin menggambarkan kondisi 
             sebenarnya. <br><br>
             Berbagai Informasi yang dapat kamu lihat di Ada-kost :<br>
            - Alamat Rumah Kost <br>
            - Foto-foto kosan dan desain kamar kost<br>
            - Harga Kost<br>
            - Keterangan fasilitas kost/kontrakan</p>
					</div>
				</div>
			</div>
		</section>
        ...
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info rounded bg-white p-4">
	            <p><span>Address:</span> Bandunng, Jawa Barat</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info rounded bg-white p-4">
	            <p><span>Phone:</span> 083173063966</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info rounded bg-white p-4">
	            <p><span>Email:</span> Adakost@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info rounded bg-white p-4">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">AdaKost</h2>
