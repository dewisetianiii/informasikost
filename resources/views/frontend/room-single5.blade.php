          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos61.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos62.jpg);"></div>
          				</div>
                        <div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos63.jpg);"></div>
          				</div>
                        <div class="item">
          					<div class="room-img" style="background-image: url(assets/frontend/images/kos64.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Kost <span>- (Siap Huni)</span></h2>
    						<p>Fasilitas: <br> 1. Kamar 2 <br> 2. Kamar mandi <br> 3. Ruang tamu <br> 4.Dapur <br><br>
                            Lokasi: <br>
                            - Kp.Sekeawi Ds.Sukamenak Kec.Margahayu Kab.Bandung <br>
